...
constexpr auto U8_CHUNK_SIZE = sizeof(__m256i) / sizeof(u8);
constexpr auto I16_CHUNK_SIZE = sizeof(__m256i) / sizeof(i16);
constexpr auto I32_CHUNK_SIZE = sizeof(__m256i) / sizeof(i32);
constexpr auto F32_CHUNK_SIZE = sizeof(__m256i) / sizeof(float);

constexpr auto NNZ_INPUT_SIMD_WIDTH = sizeof(__m256i) / sizeof(i32);
...
constexpr auto SIMD_CHUNKS = L1_SIZE / (sizeof(__m256i) / sizeof(i16));
