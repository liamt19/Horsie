...
namespace Horsie::NNUE {
    ...
    struct alignas(64) QuantisedNetworkBase {
        ...
        union {
            ...
            W L1WeightsAlt[OUTPUT_BUCKETS][L1_SIZE][L2_SIZE];
        };
        U L1Biases[OUTPUT_BUCKETS][L2_SIZE];
        U L2Weights[L2_SIZE * 2][OUTPUT_BUCKETS][L3_SIZE];
    ...
    struct alignas(64) NetworkBase {
        ...
        union {
            NDArray<W, OUTPUT_BUCKETS, L1_SIZE * L2_SIZE> L1Weights;
            NDArray<W, OUTPUT_BUCKETS, L1_SIZE,  L2_SIZE> L1WeightsAlt;
        };
        NDArray<U, OUTPUT_BUCKETS, L2_SIZE>           L1Biases;

        union {
            NDArray<U, OUTPUT_BUCKETS, L2_SIZE * 2 * L3_SIZE> L2Weights;
            NDArray<U, OUTPUT_BUCKETS, L2_SIZE * 2,  L3_SIZE> L2WeightsAlt;
        };
        NDArray<U, OUTPUT_BUCKETS, L3_SIZE> L2Biases;

        NDArray<U, OUTPUT_BUCKETS, L3_SIZE> L3Weights;
